...
var Ftp = module.exports = function (cfg) {
  ...
  this.on('data', function (data) {
    if (self.debugMode) self.emit('jsftp_debug', 'response', data || {});
  });
...
Ftp.prototype.setDebugMode = function (debugOn) {
  console.warn('`setDebugMode` is deprecated and will be removed in the ' + 'future. For debugging, set the DEBUG env variable to 1.');
